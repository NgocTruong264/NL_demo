...
<script>
import { ref } from 'vue';
import BlockIcon from '../Icon/ThongTinPage/BlockIcon.vue';
import LoaiCanHo from '../Icon/ThongTinPage/LoaiCanHo.vue';
import TangHam from '../Icon/ThongTinPage/TangHam.vue';
import TienIch from '../Icon/ThongTinPage/TienIch.vue';
export default {
